...
"$SDK_PATH/tools/android" update lib-project -p "$CORONA_PATH/Corona/android/lib/facebook-3/facebook"
checkError
...
"$SDK_PATH/tools/android" update lib-project -p "$path/../android-scoreflex-sdk"
checkError
...
ant release -D"CoronaEnterpriseDir"="$CORONA_PATH" -D"path"="$path"
checkError
